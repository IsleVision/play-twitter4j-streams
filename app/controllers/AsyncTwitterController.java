...
public class AsyncTwitterController extends Controller {
    ...
    @Inject
    public AsyncTwitterController(AssetsFinder assetsFinder, HttpExecutionContext exec, WordsFrequencyService wordsFrequencyService) {
        this.exec = exec;
        this.assetsFinder = assetsFinder;
        this.wordsFrequencyService = wordsFrequencyService;
    }
